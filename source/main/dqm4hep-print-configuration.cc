/// \file dqm4hep-print-configuration.cc
/*
 *
 * dqm4hep-print-configuration.cc main source file template automatically generated
...
int main(int argc, char* argv[])
{
  ...
  std::string ioType(cfgManager.guessIOTypeFromInput(input));
  THROW_RESULT_IF(dqm4hep::core::STATUS_CODE_SUCCESS, !=, cfgManager.readSettings(ioType, input));

  cfgManager.printConfiguration();
